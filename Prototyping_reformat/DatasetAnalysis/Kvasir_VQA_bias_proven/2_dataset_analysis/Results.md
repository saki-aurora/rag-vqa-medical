Below are the Results/Answers we got after running the experiments.ipynb file 



They essentially performed a **health check** on a medical dataset called **Kvasir-VQA** (images of gastrointestinal anatomy).


### 1. The "Vitals" (Volume Stats)

They confirmed the exact size of the dataset they are working with:
